...
# 오픈 AI Embedding 설정
embedding = OpenAIEmbeddings(model='text-embedding-3-large', api_key=ai_api_key)
...
if __name__ == "__main__":
    ...
    # print(results)
    # result = load_web_page("https://eiec.kdi.re.kr/publish/columnView.do?cidx=15029&c-code&pp=20&sel_year=2025&sel_month=01")
    # print(result[0])

    # documents = web_page_json_to_documents(f"{current_path}/data/resources_2025_0904_121522.json")

    # splits = split_documents(documents)
    # print(splits[0])
    # add_web_pages_json_to_chroma(f'{current_path}/data/resources_2025_0904_121522.json')
